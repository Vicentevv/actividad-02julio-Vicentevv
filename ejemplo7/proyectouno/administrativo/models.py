...
class Modulo(models.Model):
    ...
    valor = models.DecimalField(max_digits=10, decimal_places=2, null=True)  # Asegúrate de que este campo esté aquí
...
class Matricula(models.Model):
    ...
    # Agregar costo
    costo = models.DecimalField(max_digits=10, decimal_places=2, default=0)  # Agregado el campo costo
